//Source of this code: https://github.com/zygisS22/color-palette-extraction/blob/master/index.js
...
export const main = async () => {
  ...
  fileReader.onload = () => {
    ...
    const canvas = document.getElementById("major-color");
  ...
  const imageUrl = document
    ...
    .replace(")", "")
    .replace(/\"/gi, "")
    .replace("..", window.location.href.slice(0, -1))
    .replace("dev/", "");
  // console.log(imageUrl);
  image.src = imageUrl;
  fileReader.readAsDataURL(await urlToObject(imageUrl));
};
